    ...
    WebApp.showPopup = function (params, callback) {
        ...
        if (typeof params.buttons !== 'undefined') {
            ...
            for (var i = 0; i < params.buttons.length; i++) {
                ...
                if (button_type == 'ok' ||
                    button_type == 'close' ||
                    button_type == 'cancel') ; else if (button_type == 'default' ||
...
type WebAppType = {
    ...
    onEvent<T extends EventTypes>(eventType: T, eventHandler: (params: EventHandlers[T]) => unknown): <T extends EventTypes>(eventType: T, eventHandler: (params: EventHandlers[T]) => unknown) => void;
    offEvent<T extends EventTypes>(eventType: T, eventHandler: (params: EventHandlers[T]) => unknown): <T extends EventTypes>(eventType: T, eventHandler: (params: EventHandlers[T]) => unknown) => void;
    sendData(data: unknown): (data: unknown) => void;
    switchInlineQuery(query: string, choose_chat_types?: Array<"users" | "bots" | "groups" | "channels">): (query: string, choose_chat_types?: Array<"users" | "bots" | "groups" | "channels">) => void;
    ...
    openInvoice(url: string, callback?: (status: InvoiceStatus) => unknown): (url: string, callback?: (status: InvoiceStatus) => unknown) => void;
    ...
    showScanQrPopup(params: ScanQrPopupParams, callback?: (text: string) => void | true): (params: ScanQrPopupParams, callback?: (text: string) => void | true) => void;
...
type CloudStorage = {
    setItem(key: CloudStorageKey, value: CloudStorageValue, callback?: (error: string | null, result?: boolean) => void): (key: CloudStorageKey, value: CloudStorageValue, callback?: (error: string | null, result?: boolean) => void) => void;
    getItem(key: CloudStorageKey, callback?: (error: string | null, result?: CloudStorageValue) => void): (key: CloudStorageKey, callback?: (error: string | null, result?: CloudStorageValue) => void) => void;
    getItems(keys: Array<CloudStorageKey>, callback?: (error: string | null, result?: CloudStorageItems) => void): (keys: Array<CloudStorageKey>, callback?: (error: string | null, result?: CloudStorageItems) => void) => void;
    getKeys(callback?: (error: string | null, result?: Array<CloudStorageKey>) => void): (callback?: (error: string | null, result?: Array<CloudStorageKey>) => void) => void;
    removeItem(key: CloudStorageKey, callback?: (error: string | null, result?: boolean) => void): (key: CloudStorageKey, callback?: (error: string | null, result?: boolean) => void) => void;
    removeItems(key: Array<CloudStorageKey>, callback?: (error: string | null, result?: boolean) => void): (key: Array<CloudStorageKey>, callback?: (error: string | null, result?: boolean) => void) => void;
};
...
type GroupChannelCategoryTypes = 'group' | 'supergroup' | 'channel';
type DefaultCategoryTypes = "sender" | "private" | "group" | "supergroup" | "channel";
type DefaultColorSchemeTypes = "light" | "dark";
type ColorHexType = `#${string}`;
type ColorThemeTypes = "bg_color" | "secondary_bg_color";
type ImpactOccurredStyleType = "light" | "medium" | "heavy" | "rigid" | "soft";
...
type EventTypes = "themeChanged" | "viewportChanged" | "mainButtonClicked" | "backButtonClicked" | "settingsButtonClicked" | "invoiceClosed" | "popupClosed" | "qrTextReceived" | "clipboardTextReceived" | "writeAccessRequested" | "contactRequested" | "biometricManagerUpdated" | "biometricAuthRequested" | "biometricTokenUpdated";
type EventHandlers = {
    themeChanged: void;
    viewportChanged: {
...
declare const WebApp: WebAppType;

export { type BackButton, type BiometricAuthenticateParams, type BiometricManager, type BiometricRequestAccessParams, type BiometricType, type CloudStorage, type CloudStorageItems, type CloudStorageKey, type CloudStorageValue, type ColorHexType, type ColorThemeTypes, type DefaultCategoryTypes, type DefaultColorSchemeTypes, type EventHandlers, type EventTypes, type GroupChannelCategoryTypes, type HapticFeedback, type ImpactOccurredStyleType, type InvoiceStatus, type MainButton, type PopupButton, type PopupParams, type ScanQrPopupParams, type SettingsButton, type StatusType, type Telegram, type ThemeParams, type WebAppChat, type WebAppInitData, type WebAppType, type WebAppUser, WebApp as default };
